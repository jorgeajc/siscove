            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-heading text-center">
                        <br>
                       <h2 style="color: black;">Editar Vehículo</h2> 
                        <br>
                    </div> 
                    <div class="card-body">  
                        <div class="form-group row" class="text-center" id="tipo">
                            <label for="placa" class="col-md-4 col-form-label text-md-right" style="color:black;">{{ __('Seleccione: ') }}</label>  
                            <div class="col-md-6">
                                <input type="radio"  id="tipo" name="tipo" value="carro" {{$vehiculo->tipo == 'carro'? 'checked':''}}>Carro</option> 
                                <input type="radio"  id="tipo"  name="tipo" value="moto" {{$vehiculo->tipo == 'moto'? 'checked':''}}> Moto</option> 
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="placa" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Placa: ') }}</label> 
                            <div class="col-md-6">
                                <input id="placa" type="text" class="form-control" name="placa" value="{{ $vehiculo->placa}}" required  readonly>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="marca" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Marca: ') }}</label> 
                            <div class="col-md-6">
                                <input id="marca" type="text" class="form-control" name="marca" value="{{ $vehiculo->marca}}" required >
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="modelo" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Modelo: ') }}</label> 
                            <div class="col-md-6">
                                <input id="modelo" type="text" class="form-control" name="modelo" value="{{ $vehiculo->modelo}}" required>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="asientos" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Cantidad de Asientos: ') }}</label> 
                            <div class="col-md-6">
                                <input id="asientos" type="text" class="form-control" name="asientos" value="{{ $vehiculo->cantidadAsientos}}" minlength="1" maxlength="1" pattern="[0-9]" required>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="rtv" class="col-md-4 col-form-label text-md-right" style="color:black;">{{ __('Fecha Vencimiento de riteve (RiTeVe): ') }}</label> 
                            <div class="col-md-6">
                                <input id="rtv" type="text" class="form-control " name="rtv" value="{{ date('d/m/Y', strtotime($vehiculo->riteve)) }}" required readonly>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="marchamo" class="col-md-4 col-form-label text-md-right" style="color:black;">{{ __('Fecha Vencimiento de Marchamo: ') }}</label> 
                            <div class="col-md-6">
                                <input id="marchamo" type="text" class="form-control" name="marchamo" value="{{ date('d/m/Y', strtotime($vehiculo->marchamo)) }}" required readonly>
                            </div>
                        </div>  
                        <div> 
