...
<script>
        ...
        {
            $(".agregarMecanica").click(function(){ 
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-heading text-center">
                    <br>
                    <h2 style="color:black">Nuevo Presupuesto para Mecánica de Carro</h2> 
                    <br>
                </div>
                <div class="card-body ">
                    ...
                    @csrf
                        ...
                        <div class="form-group row" >
                            <div class="col-md-6 offset-md-4">  
                                ...
                                <button class="agregarMecanica btn bg-happy-green pull-right">
