            ...
            <div class="col-md-8"> 
                <div class="card"> 
                    <div class="card-heading text-center">
                        <br>
                        <h2 style="color:black">Editar Presupuesto para Repuestos de Carros</h2> 
                        <br>
                    </div> 
                    <div class="card-body">  
                        <div class="form-group row" style="display:none">
                            <label for="idPRC" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Código: ') }}</label> 
                            <div class="col-md-6">
                                <input id="idPRC" type="text" class="form-control{{ $errors->has('idPRC') ? ' is-invalid' : '' }}" name="identificador" value="{{ $presupuestoRC->idPRC}}" readonly autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                                <label for="fecha" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Fecha: ') }}</label> 
                                <div class="col-md-6">
                                    <input id="fechaRegistro" type="date" class="form-control{{ $errors->has('fecha') ? ' is-invalid' : '' }}" name="fecha" value="{{ $presupuestoRC->fechaRegistro }}" required autofocus>
                                </div>
                            </div> 
                        <div class="form-group row">
                                <label for="monto" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Monto Establecido: ') }}</label> 
                                <div class="col-md-6">
                                    <input id="montoEstablecido" type="text" class="form-control{{ $errors->has('monto') ? ' is-invalid' : '' }}" name="monto" value="{{ $presupuestoRC->montoEstablecido }}" required autofocus>
                                </div>
                            </div>  
                            <div class="form-group row">
                                    <div class="col-md-6 offset-md-4">
                                        ...
                                        <button class="editarPresuCar btn bg-happy-green pull-right" style="color:black">
