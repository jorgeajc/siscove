...
<script>
    ...
    {
        $(".agregarRespuesto").click(function(){ 
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-heading text-center">
                        <br>
                        <h2 style="color:black">Crear Presupuesto para Repuestos de Carros</h2> 
                        <br>
                    </div>
                    <div class="card-body "> 
                        ...
                        <div class="form-group row" >
                            <div class="col-md-6 offset-md-4">  
                                <a href="{{ route('presupuestos.inicio')}}" class="btn bg-malibu-beach pull-left">
                                    <i class="fas fa-angle-double-left" style="color:black">Regresar</i>  
                                </a>  
                                <button class="agregarRespuesto btn bg-happy-green pull-right">
