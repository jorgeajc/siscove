                ...
                <div class="card">
                    ...
                    <div class="card-body">  
                        <div class="form-group row" style="display:none">
                            <label for="idPC" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Código del Presupuesto: ') }}</label> 
                            <div class="col-md-6">
                                <input id="idPC" type="text" class="form-control{{ $errors->has('idPC') ? ' is-invalid' : '' }}" name="identificador" value="{{ $presuCombustible->idPC}}" readonly autofocus>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="fecha" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Fecha: ') }}</label> 
                            <div class="col-md-6">
                                <input id="fechaRegistro" type="date" class="form-control{{ $errors->has('fecha') ? ' is-invalid' : '' }}" name="fecha" value="{{ $presuCombustible->fechaRegistro }}" required autofocus>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="monto" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Monto Establecido: ') }}</label> 
                            <div class="col-md-6">
                                <input id="montoEstablecido" type="text" class="form-control{{ $errors->has('monto') ? ' is-invalid' : '' }}" name="monto" value="{{ $presuCombustible->montoEstablecido }}" required autofocus>
                            </div>
                        </div>  
                        <div class="form-group row">
