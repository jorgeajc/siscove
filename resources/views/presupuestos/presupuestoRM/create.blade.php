    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <br>
                    <br>
                    <h2 style="color:black">Nuevo Presupuesto para Repuestos de Motos<h2>
                    <br>
                </div>
                <div class="card-body ">
                    @csrf
                        ...
                        <div class="form-group row" >
                            ...
                            <button class="agregarRepMoto btn bg-happy-green pull-right">
