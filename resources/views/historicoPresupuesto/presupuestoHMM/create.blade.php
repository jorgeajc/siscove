...
<head>
    ...
    <script>
        $(document).ready(function(){ 
            $(".agregarHMecaMoto").click(function(){ 
                            ...
                            success: function(data) {
                                if($.isEmptyObject(data.errors)){ 
                                    Swal.fire({
                                        ...
                                        setTimeout("location.href='/historicoMM/"+idPMM+"'", 100); 
                                    });
                                }else{    
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-heading text-center">
                        <br>
                        <h2 style="color:black">{{ __('Factura de Mecánica para Motos') }}</h2>
                        <br>
                    </div> 
                    ...
                    <div class="card-body" >  
                        <div class="form-group row" style="display: none">
                            ...
                            <div class="col-md-3"> 
                                <input id="idPMM" style="text-align:right;" type="text" class="form-control " value="{{ $idPMM}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="placa" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Placa, Marca y Modelo del Vehículo: ') }}</label> 
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <button class="btn bg-malibu-beach" onclick="window.location='{{ url('historicoMM', $idPMM) }}'">
                                    <i class="fas fa-angle-double-left" style="color:black">Regresar</i>
                                </button>
                                <button class="agregarHMecaMoto btn bg-happy-green pull-right">
