            ...
            <div class="card" >  
                <div class="card-body">  
                    <div class="card-heading text-center"> 
                        <h2 style="color:black">{{ __('Historial de Gastos del Presupuesto de administración para Combustible') }}</h2>
                        <h3 style="color:black">{{ __('Municipalidad de Nicoya') }}</h3>  
                    </div>
                    <input id="idAC" value="{{ $presupuestoAC->idAC}}" style="display: none"> 
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            <div class="position-relative form-group">
                                ...
                                <label>{{ date('d/m/Y', strtotime($presupuestoAC->fechaRegistro))}}</label>
                            </div>
                        </div> 
                        <div class="col-md-4">
                            <div class="position-relative form-group"> 
                                <label>Monto Actual: </label> 
                                <label class="money">{{ $presupuestoAC->montoRestante }}</label>   
                            </div>
                        </div>
                        <div class="col-md-2" style="text-align: right;">
                            <div class="position-relative form-group"> 
                                <a class="btn bg-happy-green" href="{{ route('historicoAC.crear',$presupuestoAC->idAC) }}" style="color:black"><i class="fas fa-plus"> Nueva factura</i> </a>
                            </div>
                        </div>
                    </div>    
                    <table class="table">
                        ...
                        <tbody> 
                            @foreach($presupuestoHAC as $HC)
                                <tr class="success">
                                    ...
                                    <td>  
                                        <button class="eliminarHC btn bg-love-kiss" data-id="{{ $HC->idHAC }}" style="color:black"><i class="fas fa-trash"></i> Eliminar</button>  
                                    </td>
                                </tr> 
                            @endforeach
                        </tbody>
