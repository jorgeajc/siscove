                            ...
                            success: function(data) {
                                if($.isEmptyObject(data.errors)){ 
                                    Swal.fire({
                                        ...
                                        setTimeout("location.href='/historicoDTC/"+idDTC+"'", 100); 
                                    });
                                }else{    
            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">  
                        ...
                        <div class="form-group row">
                            <label for="placa" class="col-md-4 col-form-label text-md-right" style="color:black">{{ __('Gasolinera: ') }}</label> 
                            <div class="col-md-6">
                                <select class="form-control" id="gasolinera" name="gasolinera">
                                    <option value="">Seleccione: </option>
                                    @foreach($gasolineras as $item)
                                        <option value="{{$item->cedulaJuridica}}" required>
                                        {{$item->nombre}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4"> 
                                <button class="btn bg-malibu-beach" onclick="window.location='{{ url('historicoDTC', $idDTC) }}'">
