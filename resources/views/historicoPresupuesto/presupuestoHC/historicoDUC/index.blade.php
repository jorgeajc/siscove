            ...
            <div class="row" >
                <div class="card" >  
                    <div class="card-body">
                        ...
                        <input id="idDUC" style="display: none" value="{{ $presupuestoDUC->idDUC}}"> 
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group">
                                    ...
                                    <label>{{ date('d/m/Y', strtotime($presupuestoDUC->fechaRegistro))}}</label>
                                </div>
                            </div> 
                            <div class="col-md-4">
                                <div class="position-relative form-group"> 
                                    <label>Monto Actual: </label> 
                                    <label class="money">{{ $presupuestoDUC->montoRestante }}</label>   
                                </div>
                            </div>
                            <div class="col-md-2" style="text-align: right;">
                                <div class="position-relative form-group"> 
                                    <a class="btn bg-happy-green" href="{{ route('historicoDUC.crear',$presupuestoDUC->idDUC) }}" style="color:black"><i class="fas fa-plus"> Nueva factura</i> </a>
                                </div>
                            </div>
                        </div>    
                        <table class="table">
                            ...
                            <tbody> 
                                @foreach($presupuestoHDUC as $HC)
                                    <tr class="success">
                                        ...
                                        <td>  
                                            <button class="eliminarHC btn bg-love-kiss" data-id="{{ $HC->idHDUC }}" style="color:black"><i class="fas fa-trash"></i> Eliminar</button>  
                                        </td>
                                    </tr> 
                                @endforeach
                            </tbody>
