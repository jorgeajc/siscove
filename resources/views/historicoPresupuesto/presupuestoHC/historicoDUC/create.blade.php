                            ...
                            success: function(data) {
                                if($.isEmptyObject(data.errors)){ 
                                    Swal.fire({
                                        ...
                                        setTimeout("location.href='/historicoDUC/"+idDUC+"'", 100); 
                                    });
                                }else{    
                    ...
                    <div class="card-body">  
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4"> 
                                <button class="btn bg-malibu-beach" onclick="window.location='{{ url('historicoAC', $idDUC) }}'">
