                            ...
                            success: function(data) {
                                if($.isEmptyObject(data.errors)){ 
                                    Swal.fire({
                                        ...
                                        setTimeout("location.href='/historicoMC/"+idPMC+"'", 100); 
                                    });
                                }else{  
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-heading text-center">
                        <br>
                        <h2 style="color:black">{{ __('Factura de Mecánica para Carros') }}</h2>
                        <br>
                    </div>  
                    <div class="card-body">  
                        <div class="form-group row" style="display: none">
                            ...
                            <div class="col-md-3"> 
                                <input id="idPMC"  type="text" class="form-control " value="{{ $idPMC}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <button class="btn bg-malibu-beach" onclick="window.location='{{ url('historicoMC', $idPMC) }}'">
                                    <i class="fas fa-angle-double-left" style="color:black">Regresar</i>
                                </button>
                                <button class="agregarHMC btn  bg-happy-green pull-right  ">
