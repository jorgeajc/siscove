                            ...
                            success: function(data) {
                                if($.isEmptyObject(data.errors)){ 
                                    Swal.fire({
                                        ...
                                        setTimeout("location.href='/historicoLV/"+idPLV+"'", 100); 
                                    });
                                }else{    
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-heading text-center">
                    <br>
                    <h2 style="color: black">Facturación de Lavado del Vehículo</h2>
                    <br>
                </div> 
                ...
                <div class="card-body">  
                    <div class="form-group row" style="display: none">
                        ...
                        <div class="col-md-3"> 
                            <input id="idPLV" style="text-align:right;" type="text" class="form-control " value="{{ $idPLV}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6 offset-md-4">
                            <button class="btn bg-malibu-beach" onclick="window.location='{{ url('historicoLV', $idPLV) }}'">
