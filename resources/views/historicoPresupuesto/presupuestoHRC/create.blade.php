                            ...
                            success: function(data) {
                                if($.isEmptyObject(data.errors)){ 
                                    Swal.fire({
                                        ...
                                        setTimeout("location.href='/historicoRC/"+idPRC+"'", 100); 
                                    });
                                }else{    
            ...
            <div class="col-md-10">
                <div class="card">
                        <div class="card-heading text-center">
                            <br>
                            <h2 style="color:black">Factura de Repuestos de Carros</h2>
                            <br>
                        </div> 
                        <div class="card-body">  
                            <div class="form-group row" style="display: none">
                                <label class="col-md-4 col-form-label text-md-right" style="color:black"> Código de Registro: </label>
                                    <div class="col-md-3"> 
                                        <input id="idPRC" style="text-align:right;" type="text" class="form-control " value="{{ $idPRC}}" readonly>
                                    </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 offset-md-4">
                                    <button class="btn bg-malibu-beach" onclick="window.location='{{ url('historicoRC', $idPRC) }}'">
