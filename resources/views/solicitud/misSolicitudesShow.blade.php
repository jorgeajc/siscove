        ...
        <script>
            $(document).ready(function(){  
                if("{{$solicitudB->NecesitaConduc}}" == true){
                    document.getElementById('conductores').style.display='block';
                } 
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <div class="text-center"> 
                            @if($solicitudB->estado == "Pendiente")
                                <h2  style="color: orange;">Solicitud Pendiente</h2>
                            @elseif($solicitudB->estado == "Aceptada")
                                <h2  style="color: green;">Solicitud Aceptada</h2>
                                @elseif($solicitudB->estado == "Rechazada")
                                    <h2  style="color: red;">Solicitud Rechazada</h2>
                                    @else <h2  style="color: black;">Solicitud Cancelada</h2>
                            @endif
                        </div> 
                        ...
                        <div class="form-horizontal" style="border:ridge black 1px">
                            ...
                            <div class="form row" style="margin:1%"> 
                                <div class="col-md-6" id="vehiculos">
                                    <div class="position-relative form-group" > 
                                        <h6><label style="color:black"> Vehículo Dado: </label></h6>
                                        <input id="numPersonas" type="text" class="form-control " name="numPersonas" value="{{$solicitudB->placa}}" required autofocus readonly>
                                    </div>
                                    <div id="placaMensaje">   
                                    </div> 
                                </div> 
                                <div class="col-md-6">  
                                    <div class="position-relative form-group" id="conductores">  
                                        <h6><label style="color:black"> Conductores Disponibles: </label></h6>  
                                        <input id="numPersonas" type="text" class="form-control " name="numPersonas" value="{{$solicitudB->nombreC}}" required autofocus readonly>
                                    </div> 
                                </div> 
                            </div>  
                            <div class="form row" style="margin:1%"> 
