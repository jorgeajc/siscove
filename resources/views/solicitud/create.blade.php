    ...
    <script>
        $(document).ready(function()
        {
            $(".agregar").click(function(){
                ...
                var cantidadPersonas = $('input:radio[name=cantPersonas]:checked').val();
                ...
                console.log(NecesitaConduc);
                validaFechaHora(fechaEntrega, fechaDevolucion, horaEntrega, horaDevolucion);
                ...
                .then((willDelete) => {
                    /*toastr.info("Espere por favor", "Procesando solicitud",{
                        timeOut:15000, 
                        closeButton: true, 
                        progressBar: true, 
                    }); */ 
            ...
            $("#vehiculo").change(function(){
                ...
                if(placa.length != 0){ 
                    var radioButtonArray = document.getElementsByName('necesitaC'); 
                    for (var i=0; i<radioButtonArray.length; i++){ 
                        radioButtonArray[i].checked = false;
                    }
                    document.getElementById('conductores').style.display='none';
                    document.getElementById('buscarConductor').style.display='block';
                }else{
                    document.getElementById('buscarConductor').style.display='none';   
                } 
            });  
        ...
        function validaFechaHora(fechaEntrega, fechaDevolucion, horaEntrega, horaDevolucion){ 
            if((fechaEntrega != "") && (fechaDevolucion != "") && (horaEntrega != "") && (horaDevolucion != "")){
                if(fechaEntrega == fechaDevolucion){
                    console.log("if");
                }else{
                    console.log("else");
                            ...
                            <div class="form-row" style="margin:1% ">   
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <input id="id" type="text" class="form-control" name="cedula" value="{{$usuarios[0]->id}}" required autofocus readonly>
                                    </div> 
                                </div>  
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <h6><label for="nombreCompleto"  style="color: black">{{ __('Nombre Completo: ') }}</label></h6>
                                        <input id="nombreCompleto" type="text" class="form-control" name="nombreCompleto" value="{{$usuarios[0]->primerNombre}} {{$usuarios[0]->segundoNombre}} {{$usuarios[0]->primerApellido}} {{$usuarios[0]->segundoApellido }}" required autofocus readonly>
                                    </div> 
                                </div>   
                            </div> 
                            <div class="form-row" style="margin:1% ">  
                                <div  class="col-md-4">
                                    <div class="position-relative form-group">
                                        ...
                                        <input id="departamento" type="text" class="form-control" name="departamento" value="{{$usuarios[0]->departamento }}" required autofocus readonly>
                                    </div> 
                                </div>  
                                <div  class="col-md-4">
                                    <div class="position-relative form-group">
                                        <h6><label for="telefono"  style="color: black;">{{ __('Teléfono: ') }}</label></h6>
                                        <input id="telefono" type="text" class="form-control" name="telefono" value="{{$usuarios[0]->telefono }}" required autofocus readonly>
                                    </div> 
                                </div> 
                                <div  class="col-md-4">
                                    <div class="position-relative form-group">
                                        <h6><label for="email"  style="color: black">{{ __('Email: ') }}</label></h6>
                                        <input id="email" type="text" class="form-control" name="email" value="{{$usuarios[0]->email }}" required autofocus readonly>
                                    </div> 
                                </div>   
                            </div> 
                            <br>     
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-row" style="margin:1%">  
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <textarea id="descripcion" type="text" rows="6" cols="60" class="form-control " name="descripcion" value="{{ old('descripcion') }}"></textarea>
                                    </div>
                                </div>   
                            </div> 
                            <div class="form-row" style="margin:1% ">  
                                <div  class="col-md-5">
                                    <div class="position-relative form-group">
                                        ...
                                        <input id="destino" class="form-control " name="destino" value="{{ old('destino') }}" required autofocus>
                                    </div> 
                                </div>  
                                        ...
                                        <div id="cantPersonasID">
                                            ...
                                            <div class="col-md-8">
                                                <div class="pretty p-icon p-curve p-tada">
                                                    <input type="radio" name="cantPersonas" value="1">
                                                ...
                                                <div class="pretty p-icon p-curve p-tada">
                                                    <input type="radio" name="cantPersonas" value="2">
                                                    <div class="state p-success-o">
                                                        <i class="icon mdi mdi-check"></i>
                                                ...
                                                <div class="pretty p-icon p-curve p-tada">
                                                    <input type="radio" name="cantPersonas" value="3">
                                                    <div class="state p-success-o">
                                                        <i class="icon mdi mdi-check"></i>
                                                ...
                                                <div class="pretty p-icon p-curve p-tada">
                                                    <input type="radio" name="cantPersonas" value="4">
                                                    <div class="state p-success-o">
                                                        <i class="icon mdi mdi-check"></i>
                                                ...
                                                <div class="pretty p-icon p-curve p-tada">
                                                    <input type="radio" name="cantPersonas" value="5">
                                                    <div class="state p-success-o">
                                                        <i class="icon mdi mdi-check"></i>
                                ...
                                <div class="form-group">
                                    <div class="position-relative form-group">
                                        <div id="necesitaC">
                                            ...
                                            <div class="col-md-6">
                                                <div class="pretty p-icon p-curve p-tada">
                                                    <input type="radio" id="necesitaCsi" name="necesitaC" value="si" checked>
                                                    <div class="state p-success-o">
                                                        <i class="icon mdi mdi-check"></i>
                                                ...
                                                <div class="pretty p-icon p-curve p-tada">
                                                    <input type="radio" id="necesitaCno" name="necesitaC" value="no">
                        ...
                        <div class="form-row" style="margin:1% ">
                            <div class="col-md-12"> 
                                <div class="position-relative form-group">
                                    ...
                                    <button class="agregar btn bg-happy-green pull-right btn-lg">
                                        <i class="fas fa-check-double" style="color:black">Enviar</i>
                                    </button>   
                                </div>
                            </div>
                        </div> 
